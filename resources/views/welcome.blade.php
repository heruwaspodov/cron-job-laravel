    ...
    <div
        ...
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            ...
            @if(session()->has('success'))
                <div
                    class="flash-message success bg-green-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                    role="alert">
                    <strong class="font-bold">Holy smokes!</strong>
                    <span class="block sm:inline">{{ session()->get('success') }}</span>
                    <button type="button" class="close-btn" onclick="dismissMessage(this)">X</button>
                </div>
            @endif

            @if(session()->has('error'))
                <div
                    class="flash-message error bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                    role="alert">
                    <strong class="font-bold">Holy sh*t!</strong>
                ...
                <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                    ...
                    >
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Female</h2>
                        </div>
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">{{$totalFemale}}</h2>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Male</h2>
                        </div>
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">{{$totalMale}}</h2>
                        </div>
                    </a>
                </div>
                <div
                    class="p-4 rounded-md mt-4 bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                    <h2 class="text-xl font-semibold text-black dark:text-white">Daily Report</h2>
                    <div class="my-1"></div>
                    ...
                    <table class="w-full table-auto text-sm border text-center">
                        ...
                        @foreach ($dailyReports as $report)
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-2 px-4 border-b border-grey-light">{{$report->date}}</td>
                                <td class="py-2 px-4 border-b border-grey-light">{{$report->male_count}}</td>
                                <td class="py-2 px-4 border-b border-grey-light">{{ceil($report->male_avg_age)}}</td>
                                <td class="py-2 px-4 border-b border-grey-light">{{$report->female_count}}</td>
                                <td class="py-2 px-4 border-b border-grey-light">{{ceil($report->female_avg_age)}}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
                ...
                <div
                    ...
                    <table class="w-full table-auto text-sm border text-center">
                        ...
                        @foreach ($users as $user)
                                <?php $name = json_decode((string)$user->name); ?>
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-2 px-4 border-b border-grey-light">{{$name->title}}
                                    . {{$name->first}} {{$name->last}}</td>
                                <td class="py-2 px-4 border-b border-grey-light">{{$user->age}}</td>
                                <td class="py-2 px-4 border-b border-grey-light">{{$user->gender}}</td>
